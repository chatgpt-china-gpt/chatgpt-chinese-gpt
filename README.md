# ChatGPT 中文版：国内免费指南（支持GPT-4，无需翻墙）【6月最新更新】
...
**ChatGPT 中文版**入口：**[https://talk.lanjing.pro](https://talk.lanjing.pro)**   
...
[**ChatGPT 中文版**](https://talk.lanjing.pro) 是 OpenAI 开发的 ChatGPT 模型的中文专业版本，为中文用户提供流畅而精准的对话体验。专门针对国内用户的使用习惯进行了优化：
